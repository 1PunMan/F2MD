...
BsmCheck CaTChChecks::CheckBSM(BasicSafetyMessage bsm, NodeTable detectedNodes) {
...
void CaTChChecks::PrintBsmCheck(unsigned long senderPseudonym, BsmCheck bsmCheck) {
