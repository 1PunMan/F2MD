...
plot "../AppV2.dat" using (funcT($2)):(func3($14,$15)) title 'Cumulative Faulty V2' with lines lw 3 lc rgb "red" , \
"../AppV2Inst.dat" using (funcT($2)):(func3($14,$15)) title 'Instantaneous Faulty V2' ps 0.5 lc rgb "red" , \
