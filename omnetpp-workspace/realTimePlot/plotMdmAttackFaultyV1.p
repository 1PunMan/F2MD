...
plot "../AppV1.dat" using (funcT($2)):(func3($14,$15)) title 'Cumulative Faulty V1' with lines lw 3 lc rgb "red" , \
 ...
 "../AppV1.dat" using (funcT($2)):(func3($26,$27)) title 'Cumulative Attacker V1' with lines lc rgb "#009000" lw 3 , \
 "../AppV1Inst.dat" using (funcT($2)):(func3($26,$27)) title 'Instantaneous Attacker V1' ps 0.5 lc rgb "#009000"  
